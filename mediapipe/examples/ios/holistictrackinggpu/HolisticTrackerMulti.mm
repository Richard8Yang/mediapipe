...
+ (MPPGraph*)loadGraphFromResource: (NSString*)resource
    ...
    [newGraph setSidePacket:(mediapipe::MakePacket<bool>(params.enableFaceLandmarks)) named:"enable_face_landmarks"];
    [newGraph setSidePacket:(mediapipe::MakePacket<bool>(params.enableLeftHandLandmarks || params.enableRightHandLandmarks)) named:"enable_hands_landmarks"];
